...
../src/Simulations -m -u Cmdenv -c LowNumPorts -n .:../src --cpu-time-limit=10s omnetpp.ini
../src/Simulations -m -u Cmdenv -c IncreasingNumPorts -n .:../src --cpu-time-limit=20s omnetpp.ini
